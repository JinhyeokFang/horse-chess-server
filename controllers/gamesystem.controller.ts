...
class GameSystemController {
    ...
    public place (data, messageSender, socket): void {
        ...
        if (result.success) {
            ...
            if (result.data.gameStatus == GameStatus.InGame) {
                ...
                messageSender(roomData.data.users[0].userSocketId, "turnStart", { data: {room: roomData.data, turnBack: false} });
                messageSender(roomData.data.users[1].userSocketId, "turnStart", { data: {room: roomData.data, turnBack: false} });
            }
        } else {
    ...
    public turnEnd(data, messageSender, socket): void {
        ...
        if (result.success) {
            messageSender(result.data.room.users[0].userSocketId, "turnStart", { data: {room: result.data.room, turnBack: false} });
            messageSender(result.data.room.users[1].userSocketId, "turnStart", { data: {room: result.data.room, turnBack: false} });
        } else {
    ...
    public allowExtendTimeLimits(data, messageSender, socket): void {
        ...
        messageSender(result.data.room.users[0].userSocketId, "updateTimeLimits", { data: result.data });
        messageSender(result.data.room.users[1].userSocketId, "updateTimeLimits", { data: result.data });
    }
    ...
    public allowTurnBack(data, messageSender, socket): void {
        ...
        messageSender(result.data.room.users[0].userSocketId, "turnStart", { data: {room: result.data.room, turnBack: true} });
        messageSender(result.data.room.users[1].userSocketId, "turnStart", { data: {room: result.data.room, turnBack: true} });
    }
